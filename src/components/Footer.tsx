...
export const Footer = () => {
  return (
    <footer className="bg-stone-950 text-stone-500 py-12 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/5 flex justify-center text-[10px] uppercase tracking-[0.2em] font-bold">
