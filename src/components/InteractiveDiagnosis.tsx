    ...
    <section id="diagnostico" className="py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  activeTab === key
                    ? "bg-white border border-stone-200 text-stone-900 translate-x-2 shadow-lg"
        ...
        <div className="lg:col-span-8 px-4">
          <div className="bg-white border border-stone-100 premium-shadow rounded-[3rem] p-8 md:p-12 min-h-[450px] relative overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-12 flex-grow">
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-stone-600 leading-relaxed font-light text-lg">{symptomData[activeTab].dor}</p>
                    </div>
                    <div>
                      <span className="block text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em] mb-3">Causa Estrutural</span>
                      <p className="text-stone-600 leading-relaxed font-light text-lg">{symptomData[activeTab].causa}</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-stone-50 rounded-[2rem] p-8 border border-stone-100">
                    ...
                    <p className="text-stone-700 font-medium leading-relaxed text-lg italic serif">
